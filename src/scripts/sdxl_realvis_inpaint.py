...
if __name__ == '__main__':
    context = ExperimentalContext(seed=42, device='mps', root_dir=os.path.join('out', 'sdxl_realvis_inpaint_sample'))
    prompt = 'cat wizard, sitting on a bench'
    # prompt = 'A majestic tiger sitting on a bench'

    inference(context=context, prompt=prompt, num_inference_steps=50)
